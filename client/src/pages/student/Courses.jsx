...
import { fetchCourses, enrollCourse, myEnrollments } from '../../slices/courseSlice.js'
...
const categories = ['All', 'Programming', 'Design', 'Business', 'Marketing', 'Science', 'Other']
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">Find the perfect course for you</p>
        </div>
      ...
      <div className="space-y-4">
        <SearchBar onSearch={setSearchQuery} placeholder="Search courses by title or description..." />
      ...
      {loading ? (
        ...
        <div>
          <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
            Found {items.length} course{items.length !== 1 ? 's' : ''}
          </p>
